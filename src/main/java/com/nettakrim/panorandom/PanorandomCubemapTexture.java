...
public class PanorandomCubemapTexture extends CubemapTexture {
    ...
    private final List<NativeImage> resources;

    public PanorandomCubemapTexture(Identifier textureId, List<NativeImage> resources) {
        super(textureId);
        this.id = textureId;
    ...
    public TextureContents loadContents(ResourceManager resourceManager) throws IOException {
        ...
        NativeImage face = this.resources.get(1);
